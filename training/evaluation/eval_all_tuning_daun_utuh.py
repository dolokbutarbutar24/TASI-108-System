...
TRIALS_DIR = BASE_DIR / "Resultv7/tuning1_s_nococo"
OUTPUT_DIR = BASE_DIR / "Resultv7/result_tuning1"
DEVICE     = 0
...
with open(summary_path, "w") as f:
    ...
    for line in summary_lines:
        f.write(line + "\n")
    f.write("\nBaseline: VAL mAP50=0.8200 mAP50-95=0.6180 | TEST mAP50=0.8254 mAP50-95=0.6216\n")
