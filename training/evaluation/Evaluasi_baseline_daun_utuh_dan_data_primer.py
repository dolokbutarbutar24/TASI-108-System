...
MODEL_PATH = f"{BASE_DIR}/Resultv7/Baseline_2_nococo/weights/best.pt"
DATA_YAML  = f"{BASE_DIR}/dataset v4/Dataset_Split_3_nococo3/data.yaml"
OUTPUT_DIR = f"{BASE_DIR}/Resultv7/Evaluasi_Baseline_2"
