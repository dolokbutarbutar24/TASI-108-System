...
TRIALS_DIR = BASE_DIR / "Resultv7/tuning_area_gejala"
OUTPUT_DIR = BASE_DIR / "Resultv7/result_tuning_area_gejala"
DEVICE     = 0
...
with open(summary_path, "w") as f:
    ...
    for line in summary_lines:
        f.write(line + "\n")
    f.write("\nBaseline: VAL mAP50=0.680 mAP50-95=0.466 | TEST mAP50=0.693 mAP50-95=0.484\n")
