...
OUTPUT_DIR  = BASE_DIR / "Resultv7/tuning2_s_nococo"
...
log_path = LOG_DIR / "tuning2_s_nococo.log"
logging.basicConfig(
    level    = logging.INFO,
...
study   = optuna.create_study(
    direction      = "maximize",
    sampler        = sampler,
    study_name     = "yolov12s_tuning2_s_nococo", 
    storage        = f"sqlite:///{OUTPUT_DIR}/tuning2_nococo.db",
    load_if_exists = True,
)
