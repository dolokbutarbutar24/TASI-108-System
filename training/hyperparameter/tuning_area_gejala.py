...
DATA_PATH   = BASE_DIR / "Dataset/Datasetv6-split/data.yaml"
OUTPUT_DIR  = BASE_DIR / "Resultv7/tuning_area_gejala"
...
log_path = LOG_DIR / "tuning_area_gejala.log"
logging.basicConfig(
    level    = logging.INFO,
...
study   = optuna.create_study(
    direction      = "maximize",
    sampler        = sampler,
    study_name     = "yolov12s_tuning_area_gejala",
    storage        = f"sqlite:///{OUTPUT_DIR}/tuning_area_gejala.db",
    load_if_exists = True,
)
